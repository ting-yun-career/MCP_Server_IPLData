...
// server.tool(
//   "getIPLDataByTeam",
//   "Retrieve detailed information about a specific Indian Premier League (IPL) cricket team by their name.",
//   { team: z.string() },
//   async ({ team }) => {
//     return {
//       content: [
//         { type: "text", text: JSON.stringify(await getIPLByTeam(team)) },
//       ],
//     };
//   },
//   {
//     label: "Get IPL Team Data",
//     description:
//       "Retrieve detailed information about a specific Indian Premier League (IPL) cricket team by their name.",
//   }
// );
...
server.tool(
  "getInfo",
  "Retrieve data on myself.",
  {},
  async () => {
    // console.log("getInfo called...");
    return {
      content: [{ type: "text", text: "Name: Ting Yun" }],
    };
  },
  {
    label: "get my personal info",
    description: "Retrieve data on myself.",
  }
);
